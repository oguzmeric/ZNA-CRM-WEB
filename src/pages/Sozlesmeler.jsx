...
export default function Sozlesmeler() {
  ...
  // NOT: "Sözleşme Arşivi" girişi buradan KALDIRILDI — arşiv yalnız muhasebe
  // müdürüne açık (bkz. sozlesmeArsiviGorebilirMi). Bu sayfayı görenler zaten
  // aynı sözleşmeleri sekmelerde görüyor; buton tıklanabilir ama erişilemez
  // bir yere götürürdü.
  return (
