-- Bildirim meta'sina 'kaynak' alani eklenir — sidebar'da
-- 'Servis Talepleri' (kaynak=personel) ve 'Musteri Talepleri' (kaynak=musteri)
-- rozetlerini ayri saymak icin kullanilir.
...
declare
  ...
  v_link text;
begin
  select id, talep_no, konu, aciklama, alt_kategori, cihaz_turu, ana_tur, musteri_ad, firma_adi, kaynak
    into v_talep
