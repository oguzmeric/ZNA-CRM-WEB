-- Skor: ariza_kodu boş olan servis raporlarını hariç tut
-- (esnweb'de teknisyen henüz iş tipi seçmediği kayıtlar)
...
begin
  ...
  with birlesim as (
    ...
    where gid_tarih between baslangic and bitis
      ...
      and ariza_kodu is not null                   -- YENİ: boş ariza_kodu hariç
      and trim(ariza_kodu) <> ''                   -- YENİ: whitespace hariç
