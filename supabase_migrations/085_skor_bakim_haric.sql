-- Skor liderlik — bakımları hariç tut.
-- servis_talepleri.servis_tipi = 'bakim' → sadece bakım kalemi hariç
-- servis_raporlari.ariza_kodu ilike 'bakım' → periyodik bakım kayıtları hariç
